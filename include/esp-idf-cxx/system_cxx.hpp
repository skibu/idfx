...
/**
 * This file contains helper classes for commonly used IDF types. The classes make the use of these
 * types easier and safer. In particular, their usage provides greater type-safety of function
 * arguments and "correctness by construction".
 */
